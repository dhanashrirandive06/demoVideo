...
class Moovie {
    constructor(options) {
        ...
        var mainmenu = this.mainmenu = [
            ...
            {
                name: "subtitles",
                element: "<button id='moovie_subtitle_"+randomID+"' style=' display:none;margin-left:5px' class='player__button'><img class='opacity_svg' id='moovie_subtitle_svg_"+randomID+"' src='"+icons.path+"cc.svg'></button>",
                opcional: true,
                tooltip:  this.i18n.subtitles
            },
            {
                name: "config",
                element: "<button id='moovie_el_cog_"+randomID+"' style='display:none' class='player__button'><img src='"+icons.path+"cog.svg'></button>",
                opcional: true,
